...
mv /etc/wireguard/001.conf $(curl -s ifconfig.me) && mv /etc/wireguard/001.conf /etc/wireguard/002.conf  /etc/wireguard/003.conf  /etc/wireguard/004.conf  /etc/wireguard/005.conf $(curl -s ifconfig.me) 
